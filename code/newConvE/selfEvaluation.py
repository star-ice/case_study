...
def ranking_and_hits(model, dev_rank_batcher, vocab, name):
    ...
    for i, str2var in enumerate(dev_rank_batcher):
        ...
        for i in range(e1.shape[0]):
            ...
            print("length's of hits_left: ", len(hits_left))
            print("hits_left: ", hits_left)
